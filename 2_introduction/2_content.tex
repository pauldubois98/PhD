...
Moreover, the time-intensive nature of manual optimization and the growing demand for radiotherapy services have created a pressing need for the development of automated approaches to streamline the radiotherapy planning process.
