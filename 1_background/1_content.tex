...
Ionizing radiation damages the DNA in cells and leads to cell apoptosis, necrosis, or senescence.
...
Modern machines are now capable of delivering sufficiently high radiation to destroy tumors in minutes.
...
Multi-Leaf Collimator (MLC) technology combined with Linear Accelerators (LINAC) was a revolution in the radiotherapy world.
In a MLCs an array of motorized leaves pairs can shape the radiation beam with high precision.
% add picture + schematics
Additionally, MLC systems are sometimes equipped with jaws, which help to better shape the beams.
...
Tomotherapy systems have an irradiation head that rapidly rotates around the patient, equipped with a single layer of binary blockers that can be activated and deactivated almost instantaneously.
The tomotherapy machines follow a helical path, rotating around the patient while simultaneously moving along their body.

\subsection{CyberKnife}
CyberKnife systems is another non-invasive alternative to conventional MLC-LINAC radiotherapy machiones with higher flexibility.
...
This flexibility enables the delivery even more complex shaped doses.
CyberKnife technology is particularly beneficial for treating unusual tumors located in challenging or sensitive areas of the body.

\subsection{Brachytherapy}
Brachytherapy involves the placement of a radioactive source directly inside the body of the patient.
This technique allows delivering localized high-dose radiation.
...
The localized character of brachytherapy make it a good treatment option for some types of cancer.
