% title page
\def \englishTitle {Methods for automatization of radiotherapy treatment planning}
\def \frenchTitle {Méthodes pour l'automatisation de la planification de traitements en radiothérapie}

\def \specialty {Spécialité de doctorat: Mathématiques Appliquées}
\def \doctoralSchool {École doctorale n$^{\circ}$ 573 Interfaces: matériaux, systèmes, usages}
...
\def \directors {
	\textbf{Nikos Paragios}, Professeur, et le co-encadrement de \textbf{Paul-Henry Cournède}, Professeur
}
...
% abstract page
\def \englishKeyWords {Cancer, Radiotherapy, Digital Health, Adaptative Treatment, Artificial Intelligence, Deep Learning}
\def \frenchKeyWords {Cancer, Radiothérapie, Santé Digitale, Traitement Adaptatif, Intelligence Artificielle, Apprentissage Profond}
