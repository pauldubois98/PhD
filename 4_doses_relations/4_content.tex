...
\begin{figure}
	...
	\begin{subfigure}[c]{0.95\textwidth}
		\includegraphics[width=\linewidth]{dose_distances_figures/dose\_volume\_difference.pdf}
		\caption{Classical DVH (dose on the $x$-axis).}
		\label{fig:dose_volume_difference-normal}
	\end{subfigure}
	\begin{subfigure}[c]{0.95\textwidth}
		\includegraphics[width=\linewidth]{dose_distances_figures/dose\_volume\_difference-flipped.pdf}
