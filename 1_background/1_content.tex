...
\subsection{Molds}
The first kind of modulation used was molds: molds block the irradiation before it reaches the body.
By cleverly obscuring the rays, organs can be spared, as they will receive a small amount of irradiation dose, while the tumor will receive a fatal dose.
The idea of blocking rays remains today, but mold technology is not used anymore.
Since every patient's anatomy is different, molds were not reusable.
Typically, doctors use three molds, one for each irradiation angle of the patient.
Modern technology avoids single-use molds using motorized blockers to stop the rays.
