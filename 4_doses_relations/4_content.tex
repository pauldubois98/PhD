...
The adjacency matrices for the Wasserstein and Total Variation distances exhibit strong similarity.
This is expected, as the two metrics are effectively equivalent in this context, given that we employed the Earth Mover’s Distance (Wasserstein distance with $p=1$).
In fact, the Total Variation distance can be regarded as a special case of the Wasserstein distance.
...
Thus, in our analysis, the only expected differences between these two distance metrics should arise from numerical errors.
