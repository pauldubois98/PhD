...
15-30 minutes with 80 irradiation sessions (so-called "fractions") were delivered to relieve the pain of patients with stomach cancer.
...
Nowadays, we have machines that can kill any cancer in a few minutes (by turning the power to the maximum), but the rays would irreversibly damage the healthy organs.
