...
The mean standard deviation of the clusters, with values of 7.30, 4.51, 0.95, 2.17, and 7.92, averaging at 4.57, is significantly lower (nearly 4 times lower) compared to the mean standard deviation of the full network, which is 15.54 (see table \ref{table:cluster_std}).
