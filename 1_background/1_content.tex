...
Radiation therapy can enhance the efficacy of anti-CTLA-4
\footnote{
	...
	Bllocking this receptor induces lymphocyte activation, cytokine production and has an in vivo antitumor effect.
}
immunotherapy, a treatment that blocks the CTLA-4 protein in T cells, thus boosting the immune system's response against cancer cells.
