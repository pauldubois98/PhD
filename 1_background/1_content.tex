...
The "Step and Shoot" technique for leaf sequencing is relatively straightforward mathematically.
The fluence maps are divided into discrete levels.
Then, the MLC leaves are positioned so that the open area of the irradiation head matches the level set.
