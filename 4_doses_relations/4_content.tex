...
This distance measure is simple to compute and balance, capturing local and global differences between the curves \cite{Chatterjee2007}.
Moreover, it is computationally efficient and can handle large structures with many voxels.
It is the one that gave the best results.
Hence, we chose this distance for our analysis.
...
However, we choose to express DVHs with dose as a volume function, that is, $D: \left[ 0,1 \right] \to \R^+$.
