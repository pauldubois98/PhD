...
In the previous section, we proposes a novel approach using RL agents trained to mimic human optimization based on historical dose distributions from past treatments.
In this section, we will show that the RL agent developed above method actually allows for clinic-specific optimization.
The RL agent demonstrates adaptability to various clinical practices without requiring any additional information beyond the clinic's historical dose data.
