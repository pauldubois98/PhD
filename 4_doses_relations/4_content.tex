...
As observed in Figure \ref{fig:dose_volume_difference}, the difference between DVHs exhibits less noise (fewer fluctuations) when the dose is on the $x$-axis.
