...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		...
		Treatment Dose
		\\
		\includegraphics[width=0.6\textwidth]{serial_heat_point.pdf}
		\hfill
		\includegraphics[width=0.38\textwidth]{parallel_heat_point.pdf}
		\\
		Post Treatment
		\\
		\noindent
	...
	\hfill
	\begin{subfigure}{0.49\textwidth}
		\caption{Irradiation of organs at risk with spread heat.}
