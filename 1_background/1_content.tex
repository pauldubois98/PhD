...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{_dna_quality.pdf}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.35\textwidth}
		...
		% TODO: purple MLC on both sides?
		% MK comment: Serait-il possible mettre en violet le “Multi-Leaf Collimator” sur le schéma (b) ?
		% Cela permettrait de faire le lien entre les 2 schémas… On pourrait se rendre plus facilement compte que le schéma (b) est un “zoom” du schéma de gauche
	\end{subfigure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{_fluence_map_discretization.pdf}
	\caption{Example of a fluence map discretization.}
	\label{fig:fluence_map_discretization}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.95\linewidth]{_level_set_matching_with_leaves.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{_fluence_curve.pdf}
