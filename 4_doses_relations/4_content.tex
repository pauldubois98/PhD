...
The adjacency matrices for Wasserstein and Total Variation are very similar.
Moreover, the two measures are equivalent since we used Earth's moving distance (Wasserstein with $p=1$).
More precisely, the total variation distance can be seen as a particular case of the Wasserstein distance.
