...
\begin{figure}
	\centering
	\includegraphics[width=0.5\linewidth]{constraint_plot.pdf}
	\label{fig:constraint_plot}
	\caption{Typical DVH of an OAR, with the visualization of the constraint $D_{20\%} \leq 25\,\text{Gy}$ (or $V_{25\text{Gy}} \leq 20\,\%$).}
\end{figure}
